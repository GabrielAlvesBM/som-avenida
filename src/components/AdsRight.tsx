...
const AdsRight = () => {
    return (
        <div className="grid grid-cols-2 gap-2 w-full p-1 mx-auto bg-adsBg md:max-w-[250px] md:ml-2 md:grid-cols-none">
            ...
            <Image className='w-full max-w-[250px] rounded-xl md:max-w-none'
                src="/images/ads-gildogas.jpeg"
                alt="Ads Do Gil do Gas"
                width={250}
                height={150}
            />
            <Image className='col-span-2 mx-auto w-full max-w-[250px] rounded-xl md:max-w-none md:col-span-full'
