...
const FormComment = () => {
    return (
        <section className="w-full p-3 bg-myLightBlack2 md:max-w-[500px]">
            <form action="" method="POST" className={`${montserrat.className} grid p-3 bg-myLightBlack`}>
                <div className="mb-3">
                    ...
                    className="w-full h-[33px] mt-1 text-black" />
                </div>
                <div className="mb-3">
                ...
                <div className="mb-3">
                    ...
                    className="w-full min-h-[200px] mt-1 text-black" ></textarea>
                </div>
